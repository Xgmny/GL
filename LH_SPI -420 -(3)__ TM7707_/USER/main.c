...
#include "mport.h"
  ...
  u8 Version[8]={0x32,0x32,0x2e,0x31,0x31,0x2e,0x31,0x35};//版本号
...
//	LED0=1;        
 	while(1)
	{	
//		if(can200sm>99){CAN_Mode_Init(CAN_SJW_1tq,CAN_BS2_8tq,CAN_BS1_9tq,8,0);can200sm=0;}else;    //CAN重置
